...
public class Committer__1 implements Parcelable
{
    ...
    public final static Creator<Committer__1> CREATOR = new Creator<Committer__1>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Committer__1 createFromParcel(android.os.Parcel in) {
            return new Committer__1(in);
        }

        public Committer__1 [] newArray(int size) {
            return (new Committer__1[size]);
        }

    }
    ;

    protected Committer__1(android.os.Parcel in) {
