...
package com.touhid.githubrepo.pojo.userprofile;
...
public class UserProfileResponse implements Parcelable {
    ...
    public final static Creator<UserProfileResponse> CREATOR = new Creator<UserProfileResponse>() {


        @Override
        public UserProfileResponse createFromParcel(android.os.Parcel in) {
            return new UserProfileResponse(in);
        }

        @Override
        public UserProfileResponse[] newArray(int size) {
            return (new UserProfileResponse[size]);
        }

    };

    protected UserProfileResponse(android.os.Parcel in) {
